...
import { faPlus, faSpinner, faSignOutAlt, faSignInAlt } from '@fortawesome/free-solid-svg-icons';
import {
  Web3ReactProvider,
  useWeb3React,
...
export const Authenticate = (props) => {
  ...
  return (
    <div>
      <Modal isOpen={modal} toggle={toggle} className="walletModal modal-dark mx-2 mx-md-auto" backdrop={backdrop} keyboard={keyboard}>
                  ...
                  <div className='mb-2'>
                    <button
                      ...
                      <div className='d-flex justify-content-between'>
                        <span className='mt-1 font-weight-bold'>{name == "Injected" ? "MetaMask" : [name == "WalletConnect" ? "WalletConnect" : name]}</span>
                        <img src={"/providers/" + name.toLowerCase() + ".png"} style={{ width: "32px" }} className="img-fluid" />
                      </div>
                    </button>
                  </div>
                </div>
