            ...
            >
              <div className="span-txts">
                ...
                <p className="span4b-txts">
                  ...
                  to generate EUSD in the Egoras Protocol. its main
                  purpose is to help maintain the stability of eUSD.
                </p>
        ...
        <div className="container">
          <div className="secondCu filter2 reverse">
            ...
            <div className="widthAjustBA">
              ...
              <p className="earn3">
                EGC is elementary in the stability of EUSD. It is held
                in a reserve smart-contract and exchanged for eUSD to
