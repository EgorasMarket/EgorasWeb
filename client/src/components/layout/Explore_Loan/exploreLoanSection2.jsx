  ...
  const Roll = [
    {
      ...
      interest: "interest :",
      interest2: "50% APY",
      header: "For identity photo studio",
    },
    {
      id: 2,
      img: "pages.jpg",
      ...
      <div className="section2DivHolder_img">
        {Roll.map((bag) => (
          <div className="exploreLoanSection2" key={bag.id}>
            ...
            <div>
              <span className="interestSpan">{bag.interest}</span>{" "}
              <span className="percentageSpan">{bag.interest2}</span>
            </div>
          </div>
        ))}
=======
...
>>>>>>> 1aa6b7a14b121004846cb57e115fb7494b004616
      </div>
    </div>
  );
};
