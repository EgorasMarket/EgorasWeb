...
const Adminproduct = () => {
  ...
  useEffect(() => {
    ...
    // var divContents = document.getElementById("mainContent").innerHTML;
        ...
        printWindow.document.write('<body style="height: min-content;font-family: roboto;margin: 0; border-bottom: 1px solid black;font-weight:400;">');
        ...
        printWindow.document.write('<h3 style="margin: 0;">'+product_code+'</h3>');
        printWindow.document.write('</div>');
  ...
  const printProductPrice = (product_name, amount) => {
    ...
    // var divContents = document.getElementById("mainContent").innerHTML;
        ...
        printWindow.document.write('<h5 style="margin: 0;">'+product_name+'</h5>');
        printWindow.document.write('</div>');
        printWindow.document.write('</body>');
        printWindow.document.write('</html>');
        printWindow.document.close();
